...
{
    // 弹出的整个视图
    _wholeView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth, 300)];
    ...
    // pickerView
    _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 40, ScreenWidth, 300-100)];
...
- (void)showBottomView
{
    ...
    {
        _wholeView.frame = CGRectMake(0, ScreenHeight-300, ScreenWidth, 300);
...
- (void)hiddenBottomView
{
    [UIView animateWithDuration:0.3 animations:^
    {
        _wholeView.frame = CGRectMake(0, ScreenHeight, ScreenWidth, 300);
